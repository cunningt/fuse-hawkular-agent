 ...
 */
package org.fuse.hawkular.agent.monitor.inventory;
...
public class InventoryIdUtilTest {
    ...
    public void testParsingResourceId() {
        ...
        EndpointConfiguration endpointConfig = new EndpointConfiguration("testmanagedserver", true,
                Collections.<Name>emptyList(), null, null, null, null, null, null, null);
    ...
    public static void main(String args[]) {
        InventoryIdUtilTest lrt = new InventoryIdUtilTest();
        org.junit.runner.JUnitCore.main("org.fuse.hawkular.agent.monitor.inventory.InventoryIdUtilTest");
    }
