...
public class JMXLocationResolverTest extends JMXLocationResolver {
    ...
    public static void main(String args[]) {
        JMXLocationResolverTest lrt = new JMXLocationResolverTest();
        org.junit.runner.JUnitCore.main("org.fuse.hawkular.agent.JMXLocationResolverTest");
        System.out.println("Starting tests...");
        try {
            lrt.testFindWildcardMatch();
            lrt.testIsMultiTarget();
            lrt.testAbsolutize();
            lrt.testIsParent();
            lrt.testMatches();
            lrt.testApplyTemplate();
        } catch (Exception e) {
            e.printStackTrace();
        }
