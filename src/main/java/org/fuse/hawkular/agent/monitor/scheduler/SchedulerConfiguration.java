 ...
 */
package org.fuse.hawkular.agent.monitor.scheduler;
...
public class SchedulerConfiguration {
    ...
    private StorageType storageAdapterConfig;
    private DiagnosticsType diagnosticsConfig;
    ...
    public StorageType getStorageAdapterConfig() {
        return this.storageAdapterConfig;
    }

    public void setStorageAdapterConfig(StorageType config) {
        this.storageAdapterConfig = config;
    }

    public DiagnosticsType getDiagnosticsConfig() {
        return diagnosticsConfig;
    }

    public void setDiagnosticsConfig(DiagnosticsType config) {
