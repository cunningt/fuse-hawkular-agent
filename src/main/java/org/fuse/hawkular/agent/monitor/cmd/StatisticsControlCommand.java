...
public class StatisticsControlCommand
    ...
    protected void success(BasicMessageWithExtraData<StatisticsControlRequest> envelope,
        ...
        settings.put(null, new ArrayList<String>());
        settings.put(StatisticsSetting.ENABLED, new ArrayList<String>());
        settings.put(StatisticsSetting.DISABLED, new ArrayList<String>());
