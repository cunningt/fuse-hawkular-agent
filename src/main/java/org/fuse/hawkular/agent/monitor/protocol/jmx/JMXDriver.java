 ...
 */
package org.fuse.hawkular.agent.monitor.protocol.jmx;
...
public class JMXDriver implements Driver<JMXNodeLocation> {
    ...
    public Map<JMXNodeLocation, ObjectName> fetchNodes(JMXNodeLocation query) throws ProtocolException {
        try {
            ...
            System.out.println("REQUEST : " + searchReq.getObjectName().toString());
            System.out.println("RESPONSE : " + searchResponse.asJSONObject().toString());
