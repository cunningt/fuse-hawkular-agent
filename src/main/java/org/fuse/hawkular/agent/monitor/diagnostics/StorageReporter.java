 ...
 */
package org.fuse.hawkular.agent.monitor.diagnostics;
...
public class StorageReporter extends ScheduledReporter {
    ...
    private final DiagnosticsType diagnosticsConfig;
    ...
    private StorageReporter(String feedId,
            ...
            MetricFilter filter,
            DiagnosticsType diagnosticsConfig,
    ...
    public static Builder forRegistry(MetricRegistry registry,
            DiagnosticsType diagnosticsConfig, StorageAdapter storageAdapter) {
